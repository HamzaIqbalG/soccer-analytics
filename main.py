...
# imgsz=1280 forces the AI to look in HD, so it sees the small players in the back
results = model.track(source=video_path, show=True, save=True, stream=True, conf=0.3, imgsz=1280)
